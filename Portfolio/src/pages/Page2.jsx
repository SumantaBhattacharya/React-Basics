...
const Page2 = () => {
  ...
  // h-[440vh] max-h-screen
  return (
    <div id="section2" className=" min-h-screen w-[100%] text-center mt-20">
      <h1 className="font-[FontThree] text-[1vw] text-[#9B9B9B] mt-5 mb-32 ">
        {" "}
        &copy; anzo.studio 2024 | designed and devloped
      </h1>
      ...
      <div className="h-1 w-1/3 relative left-1/2 -translate-x-1/2 bg-black">
      </div>
